...
exports.releaseListingSeats = releaseListingSeats;
exports.consumeListingSeats = consumeListingSeats;
...
async function releaseListingSeats(tx, listingId, seatsCount) {
    await tx.$executeRaw `
    UPDATE "Listing"
    SET
...
async function consumeListingSeats(tx, listingId, seatsCount) {
...
//# sourceMappingURL=listingSeats.js.map