...
exports.SELLER_TRUST_MIN_COMPLETED_SALES = void 0;
exports.getSellerDeliveryEligibility = getSellerDeliveryEligibility;
...
// cleanup one.
exports.SELLER_TRUST_MIN_COMPLETED_SALES = 3;
async function getSellerDeliveryEligibility(sellerId) {
    const [completedSales, unresolvedFlagCount] = await Promise.all([
        ...
        prisma_1.prisma.manualReviewFlag.count({
            where: { resolvedAt: null, transaction: { listing: { sellerId } } },
        }),
    ]);
    const hasUnresolvedReviewFlags = unresolvedFlagCount > 0;
    return {
        emailForwardEligible: completedSales >= exports.SELLER_TRUST_MIN_COMPLETED_SALES && !hasUnresolvedReviewFlags,
        completedSales,
        requiredCompletedSales: exports.SELLER_TRUST_MIN_COMPLETED_SALES,
        hasUnresolvedReviewFlags,
    };
}
//# sourceMappingURL=sellerTrust.js.map