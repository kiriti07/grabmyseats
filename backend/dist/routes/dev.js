...
exports.devRouter.post("/simulate-payment-captured/:transactionId", auth_1.requireAuth, auth_1.requireAdmin, async (req, res) => {
    ...
    const result = await (0, handlePaymentCaptured_1.handlePaymentCaptured)(transaction, transaction.razorpayOrderId);
